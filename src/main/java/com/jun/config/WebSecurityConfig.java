...
import com.jun.security.UserDetailService;
import com.jun.security.WebFilterSecurityInterceptor;

/**
 * spring security config file
 * 
 * @author jun
 * @date 2018年3月26日 : 上午10:05:15
 */
@Configuration
@EnableWebSecurity
@EnableWebMvc
@Import({WebMvcConfig.class,DelegatingWebMvcConfiguration.class})
