...
<%
  Date startTime1 = (Date) jspContext.getAttribute("startTime");
  Date endTime1 = (Date) jspContext.getAttribute("endTime");

  try {
    long duration = (endTime1.getTime() - startTime1.getTime()) / 1000;
