...
<html lang="en">
  ...
  <head>
    <%@include file="/cdn/meta.jsp"%>
    <title>管理员</title>
    <%@include file="/cdn/s3.jsp"%>
...
$(function() {
  ...
  <body>
    <%@include file="/content/header/my.jsp"%>

    <div class="row-fluid">
	  <%@include file="/content/menu/my.jsp"%>

	  <!-- start of main -->
      <section id="m-main" class="col-md-10 col-md-offset-2" style="margin-top:65px;">
