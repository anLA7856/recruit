...
<div class="panel-group col-md-2" id="accordion" role="tablist" aria-multiselectable="true" style="padding-top:65px;position: fixed;">
    ...
    <div id="collapse-body-bpm-process" class="panel-collapse collapse ${currentMenu == 'my' ? 'in' : ''}" role="tabpanel" aria-labelledby="collapse-header-bpm-process">
      <div class="panel-body">
        <ul class="nav nav-list">
		  ...
		  <li><a href="${tenantPrefix}/user/my-family-input.do"><i class="glyphicon glyphicon-list"></i> 家属信息</a></li>
